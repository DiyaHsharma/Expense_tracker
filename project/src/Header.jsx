...
function Header() {
    return (
        ...
        <div className='h-[14vh] w-full sticky top-0 bg-gradient-to-b from-slate-500 via-slate-800 to-black text-white flex justify-between items-center px-6 z-50'>
